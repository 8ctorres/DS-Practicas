...
public class EuroCoinCollectionTest {
    ...
    public void setUp() {
        ...
        e1_sp1 = new EuroCoin(100, Countries.ES, "JC", 2000);
        e1_sp2 = new EuroCoin(100, Countries.ES, "F", 2000);
        e2_sp_2002  = new EuroCoin(200, Countries.ES, "", 2002);
        e2_sp_2005 = new EuroCoin(200, Countries.ES, "", 2005);
        c50_it = new EuroCoin(50, Countries.IT, "", 2000);
        c20_fr = new EuroCoin(20, Countries.FR, "", 2000);
        c1_pt = new EuroCoin(1, Countries.PT, "", 2000);
